...
//Now create and push into your users array 3 separate instances of User 
...
//Now create another instance of User using your own information and then add that to your users array.
 ...
 var me = new User("Alex", "alexdecapri@gmail.com", "password");
 users.push(me);

console.log('All my users names are ');
//Now loop through your users Array and console.log every users name. 

users.forEach(function(placeholder) {
  console.log(placeholder.name);
});

//OR use this if it makes more sense
